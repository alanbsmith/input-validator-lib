...
* Create a fork of this repository, then clone the fork to your local development environment: `git clone https://github.com/YOUR_USERNAME/input-validator-lib.git`
...
* [Submit a pull request](https://github.com/Decisiv/input-validator-lib/compare) to the upstream `input-validator-lib` repository.
